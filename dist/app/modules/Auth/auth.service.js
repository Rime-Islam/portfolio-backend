...
const jwtTokenFunction_1 = require("../../utilits/jwtTokenFunction");
...
const userLogin = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!userinfo) {
        throw new AppError_1.default(401, "Check your email");
    }
    if ((yield bcrypt_1.default.compare(data.password, userinfo.password)) == false) {
        throw new AppError_1.default(401, "Check your password");
    }
    const token = (0, jwtTokenFunction_1.tokenGenerator)({
